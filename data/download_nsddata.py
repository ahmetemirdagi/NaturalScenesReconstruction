...
# Download all files from ROI folder recursively
import os

for sub in [1, 2, 5, 7]:
    os.system(
        'aws s3 cp --no-sign-request --recursive '
        's3://natural-scenes-dataset/nsddata/ppdata/subj{:02d}/func1pt8mm/roi/ '
        'nsddata/ppdata/subj{:02d}/func1pt8mm/roi/'.format(sub, sub)
    )
